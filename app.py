...
#         st.write(f"Welcome, **{user}**! Use the sidebar to navigate.")
...
#                 st.session_state.users[user]["data"][encrypted_text] = hashed_passkey
...
#                 user_data = st.session_state.users[user]["data"]
#                 hashed_input = hash_text(passkey_input)

#                 if encrypted_input in user_data and user_data[encrypted_input] == hashed_input:
#                     st.session_state.failed_attempts = 0
